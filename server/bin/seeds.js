...
let beers = [
  ...
  {
    id: 86,
    name: 'Original Dogma (Née Speedball)',
  ...
  },
  {
    ...
    food_pairing: ['Celery and stilton soup', 'Salted caramel soufflé'],
    brewers_tips:
  ...
  },
  {
    ...
    brewers_tips:
      'Dry hop using a muslin bag in order to give you the best chance at getting the signature Kölsch clarity.',
    contributed_by: 'Sam Mason <samjbmason>',
  },
  {
    id: 155,
  ...
  {
    id: 158,
    name: 'Hello My Name Is Zé (w/ 2Cabeças)',
...
Beer.deleteMany()
  ...
  .then(beersCreated => {
    console.log(`${beersCreated.length} users created with the following id:`)
